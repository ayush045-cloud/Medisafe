...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-Ct-Bc8c-.js";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Zduhn2fn.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C499q6vM.js"),
		import("./start-DVnOPYrN.js"),
